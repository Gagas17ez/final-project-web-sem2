...
<div class="main">
    ...
    <div class="form-title">Upload Materi MataKuliah</div>
    <div class="card-deck">
    <div class="card text-white bg-dark">
        <div class="card-body">
        <h1 class="card-title">ASD D4 ITB 2020</h1>
        <a href="uploadmateri.php?namakelas=<?php echo $asd; ?>" class="btn btn-primary btn-lg">lihat Pengumpulan</a>
        <p class="card-text"><small class="text-muted">25 Mahasiswa</small></p>
        </div>
    </div>
    <div class="card text-white bg-dark">
        <div class="card-body">
        <h1 class="card-title">Basis Data D4 ITA 2020</h1>
        <a href="uploadmateri.php?namakelas=<?php echo $bs; ?>" class="btn btn-primary btn-lg">lihat Pengumpulan</a>
        <p class="card-text"><small class="text-muted">30 Mahasiswa</small></p>
        </div>
    </div>
    <div class="card text-white bg-dark">
        <div class="card-body">
        <h1 class="card-title">System Operasi D3 ITA 2020</h1>
        <a href="uploadmateri.php?namakelas=<?php echo $os; ?>" class="btn btn-primary btn-lg">lihat Pengumpulan</a>
