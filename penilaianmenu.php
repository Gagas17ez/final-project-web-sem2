...
<div class="main">
    ...
    <div class="card text-white bg-dark">
        <div class="card-body">
        <h1 class="card-title">D4 ITB 2020</h1>
        <a href="tugaskelas.php?namakelas=<?php echo $kelasd4b; ?>" class="btn btn-primary btn-lg">lihat Pengumpulan</a>
        <p class="card-text"><small class="text-muted">25 Mahasiswa</small></p>
        </div>
    </div>
    <div class="card text-white bg-dark">
        <div class="card-body">
        <h1 class="card-title">D4 ITA 2020</h1>
        <a href="tugaskelas.php?namakelas=<?php echo $kelasd4a; ?>" class="btn btn-primary btn-lg">lihat Pengumpulan</a>
        <p class="card-text"><small class="text-muted">30 Mahasiswa</small></p>
        </div>
    </div>
    <div class="card text-white bg-dark">
        <div class="card-body">
        <h1 class="card-title">D3 ITA 2020</h1>
        <a href="tugaskelas.php?namakelas=<?php echo $kelasd3a; ?>" class="btn btn-primary btn-lg">lihat Pengumpulan</a>
