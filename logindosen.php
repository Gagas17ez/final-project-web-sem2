...
if (isset($_POST['txtUserId']) && isset($_POST['txtPassword'])) {
    ...
    $sql = "SELECT user_id FROM dosen WHERE user_id = '$userId' AND user_password ='$password'";
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        $errorMessage = 'Mohon Maaf UserId Dosen anda Salah';
    }
...
<body>
  ...
  <section id="contact">
			<div class="section-content">
				<h1 class="section-header">Login Dosen</h1>
            ...
            <form action="" method="post" name="frmLogin" id="frmLogin">
			  			<div class="form-group">
			  				<label for="nama">UserName Dosen</label>
