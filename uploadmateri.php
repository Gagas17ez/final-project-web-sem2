...
if (!in_array($cek,$tipeFile)) {
  ...
  echo "<script> alert('Berhasil Upload');</script>";
    if ($ukuran < 5097152) {
        ...
        mysqli_query($koneksi,"INSERT INTO materi VALUES (NULL,'$namaFile','$cek','$ukuran','$deskripsi','$pengumpul','$matkul')");
        
        header("Location: completemateri.php");
    }else {
...
<div class="main">
    <div class="display-contact">
      <div class="form-title">Upload Materi <?php echo $matkul ?></div>
