...
<?php
echo "<h1 style='color:white;'>File Berhasil Upload</h1>" . "<h3 style='color:white;'>$nama</h3>"; 
?>
<a href="uploadmenu.php" type="button" class="btn btn-primary btn-lg subs-btn">Kembali Ke Upload Page</a>
</div>
</body>