...
<?php
echo "<h1 style='color:white;'>Nilai Berhasil di Upload</h1>"; 
?>
<a href="penilaianmenu.php" type="button" class="btn btn-primary btn-lg subs-btn">Kembali Ke Tugas Page</a>
</div>
</body>