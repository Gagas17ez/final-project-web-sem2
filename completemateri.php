...
<?php
echo "<h1 style='color:white;'>Materi Berhasil di Upload</h1>"; 
?>
<a href="uploadmenumateri.php" type="button" class="btn btn-primary btn-lg subs-btn">Kembali Ke Upload Materi</a>
</div>
</body>